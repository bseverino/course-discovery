    ...
    def update_facts(self, instance, facts_data):
        ...
        if len(existing_facts) == len(facts_data):
            ...
            for fact in facts_data:
                ...
                # only make relation with the orphan fact object else create a new one
                # updating a fact (as in above if) attached to more than one course may
                # result in unwanted update
